'use strict';
angular.module("MCMRelationshop.StoreLocator", ['uiGmapgoogle-maps'])
...
.controller("StoreLocatorCtrl",['$scope', '$timeout', 'uiGmapLogger', '$http', 'rndAddToLatLon','uiGmapGoogleMapApi'
